...
export const PhoneIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M22 16.9v2a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3.1 19.5 19.5 0 0 1-6-6A19.8 19.8 0 0 1 2.1 3.2 2 2 0 0 1 4.1 1h2a2 2 0 0 1 2 1.7c.1.9.3 1.8.6 2.7a2 2 0 0 1-.5 2.1L7.1 8.6a16 16 0 0 0 6 6l1.1-1.1a2 2 0 0 1 2.1-.5c.9.3 1.8.5 2.7.6a2 2 0 0 1 1.7 2Z" />
  </svg>
);
...
export const WeChatIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M8.5 4C4.9 4 2 6.5 2 9.6c0 1.7.9 3.3 2.4 4.3l-.6 2.2 2.6-1.3c.6.2 1.3.3 2 .3" />
    <path d="M22 14.5c0-2.8-2.6-5.1-5.7-5.1-3.2 0-5.7 2.3-5.7 5.1S13.1 19.6 16.3 19.6c.7 0 1.4-.1 2-.3l2.3 1.1-.5-1.9c1.1-.9 1.9-2.3 1.9-4Z" />
  </svg>
);
...
export const EyeOffIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    <path d="M10.7 6.1A9.9 9.9 0 0 1 12 6c6.2 0 9.8 6 9.8 6a17.7 17.7 0 0 1-2.4 3.1" />
    <path d="M6.5 7.7A17.4 17.4 0 0 0 2.2 12S5.8 18 12 18a9.6 9.6 0 0 0 4.1-.9" />
    <path d="M9.8 10.2a2.8 2.8 0 0 0 4 4" />
    <path d="M3 3l18 18" />
  </svg>
);
